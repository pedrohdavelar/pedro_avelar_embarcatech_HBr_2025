...
inline int ssd1306_get_font(uint8_t character)
{
  ...
  //vou incluir caracteres para as setas: < (37) > (38) ^ (39) # 40 (se eu usar o v para seta para baixo pode complicar no futuro!)
  //inclui . para fazer o espaço
  else if (character == '<') {
    return 37;
  } else if (character == '>') {
    return 38;
    ...
    return 41;
  } else if (character == '-'){ // preciso finalizar a tabela ascii =/
    return 42;
  } else if (character == '.'){
    return 43;
  }
